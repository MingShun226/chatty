  ...
  const completeOnboarding = async () => {
    ...
    try {
      ...
      if (data.chatbotName) {
        ...
        // Create initial prompt version so it shows in prompt-engineer tab
        try {
          await TrainingService.createPromptVersion({
            ...
            description: 'Auto-generated during onboarding wizard setup',
            system_prompt: data.generatedPrompt,
            personality_traits: [data.chatbotTone],
            behavior_rules: defaultResponseGuidelines,
            is_active: true,
            is_published: true,
          });
        } catch (promptVersionError) {
          console.error('Error creating prompt version:', promptVersionError);
